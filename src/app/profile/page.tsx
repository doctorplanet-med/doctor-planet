...
export default function ProfilePage() {
  ...
  // Mobile Profile Menu View
  const MobileProfileMenu = () => (
    <div className="sm:hidden min-h-screen pt-14 pb-20 bg-secondary-50">
  ...
  const DesktopView = () => (
    <div className="hidden sm:block min-h-screen pt-24 pb-12 bg-secondary-50">
  ...
  return (
    <>
      {/* Mobile View */}
      {showEditForm ? <MobileEditForm /> : <MobileProfileMenu />}
