    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-secondary-500 mt-1">Manage and print product barcodes</p>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-secondary-50 border-b border-secondary-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm font-semibold text-secondary-700">Barcode</th>
                    ...
                    <tr key={product.id} className="hover:bg-secondary-50">
                      ...
                      <td className="px-4 py-3">
                        {product.barcode ? (
                          ...
                          <div className="flex items-center gap-2">
                            <span className="text-sm text-secondary-400">No barcode</span>
