...
export default function ProductsContent({
  ...
  return (
    <div className="min-h-screen pt-0 sm:pt-20 bg-gradient-to-br from-secondary-50 via-white to-secondary-50">
      ...
      <div className="relative w-full max-w-[1600px] mx-auto px-3 sm:px-4 lg:px-6 pt-4 pb-4 sm:py-8">
                ...
                <ul className="space-y-2">
                  ...
                  {categories.map((category, i) => (
                    ...
                    >
                      ...
                      {currentCategory === category.slug && category.subCategories && category.subCategories.length > 0 && (
                        <ul className="mt-1 ml-4 space-y-0.5 border-l-2 border-primary-100 pl-3">
                          <li>
                            <button
